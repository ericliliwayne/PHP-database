...
<body>
    ...
    <form action="update.php" method="post">
        ...
        <label for="">班級座號:
            <input type="text" name="seat_num" value="<?=$student['seat_num'];?>">
        </label>
        <label for="">姓名:
        ...
        <label for="">電話:
            <input type="text" name="telphone" value="<?=$student['telphone'];?>">
        </label>
        <label for="">科別:
            <input type="text" name="major" value="<?=$student['major'];?>">
        </label>
        <label for="">畢業國中:
            <input type="text" name="secondary" value="<?=$student['secondary'];?>">
        </label>
